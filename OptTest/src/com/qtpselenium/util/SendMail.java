...

{
...

	{
		...
		String body = "Hello,\n\n" +
				"Please find the complete test report of scenarios covered.\nLet me know in case of any concern" +
				"\n\n Thanks\n";
		String[] to = {"meenu.jain@optimusinfo.com"}; //update the to , cc and bcc
		String[] cc = {};
		String[] bcc = {};

		// This is for google

		SendMail.sendMail("rewstream.1@optimusinfo.com",
				"optimus123",
				"smtp.gmail.com",
				"465", 
				"true",
				...
				cc,
				bcc,
				"RewardStream Automation Test Reports",
				body,
				path, 
				"Test_Reports.zip");
